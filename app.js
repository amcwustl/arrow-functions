...
//"this" refers to the object that we are inside when joe.scope() is invoked.  In this example, it is a Student object with the name of "Joe"
//
// 2. What is "this" when joe.scopeArrow() is invoked?

//"this" refers to the window when joe.scopeArrow() is invoked.
//
// 3. Explain why "this" is different when an arrow function is used.
//
// "this" is different with arrow functions because regular functions inherit their this from the object on which the function is invoked or the object that owns the method being called.  With arrow functions, they inherit their "this" from the enclosing lexical scope.  This means that "this" inside the arrow function is the same as the "this" outside of the arrow function.